...
import com.example.wts.adapter.ImageAdapter;
import com.example.wts.model.Status;
import com.example.wts.utils.Common;
...
public class ImageFragment extends Fragment {
    ...
    private final List<Status> imagesList = new ArrayList<Status>();
                ...
                if (statusFiles != null && statusFiles.length > 0) {
                    ...
                    for (File file : statusFiles) {
                        ...
                        if (!status.isVideo() && status.getTitle().endsWith(".jpg") &&
                            status.getTitle().endsWith(".png") &&
                            status.getTitle().endsWith(".webp")
                        ) {
